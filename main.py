...
# Player
player_img = pygame.image.load("pictures/player.png")
playerX = 368
playerY = 500
playerX_change = 0
...
for i in range(num_of_enemies):
    enemy_img.append(pygame.image.load("pictures/enemy.png"))
...
def show_score(x, y):
    score = font.render("Score : " + str(score_value), True, (170, 0, 0))
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # If keystroke pressed check the direction ( L/R )
